...
// Some code changes 15.5.2017 Kirsi Oikarinen and Maija Prove
...
byte mac[] = { 0xA0, 0xD3, 0xC1, 0x48, 0x51, 0xEE }; // Must be unique on local network

// ThingSpeak Settings
char thingSpeakAddress[] = "api.thingspeak.com";
String writeAPIKey = "7BZLHGKTXDKFCSH4"; 
...
void loop()
{
  // Read value from Analog Input Pin A4
  String analogValue0 = String(analogRead(A4), DEC); 
